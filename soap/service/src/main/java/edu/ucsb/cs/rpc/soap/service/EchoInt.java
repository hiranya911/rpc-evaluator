...
public class EchoInt implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":echoInt", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "echoInt", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static EchoInt parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            EchoInt object = new EchoInt();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"echoInt".equals(type)) {
                            ...
                            return (EchoInt) edu.ucsb.cs.rpc.soap.service.types.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
