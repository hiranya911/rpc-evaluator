...
public class EchoBlob implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":echoBlob", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "echoBlob", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static EchoBlob parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            EchoBlob object = new EchoBlob();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"echoBlob".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (EchoBlob) edu.ucsb.cs.rpc.soap.service.types.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
