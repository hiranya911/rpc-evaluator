...
/**
 *  EchoBlobResponse bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class EchoBlobResponse implements org.apache.axis2.databinding.ADBBean {
    public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName("http://base.rpc.cs.ucsb.edu",
            "echoBlobResponse", "ns3");
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":echoBlobResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "echoBlobResponse", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static EchoBlobResponse parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            EchoBlobResponse object = new EchoBlobResponse();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"echoBlobResponse".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (EchoBlobResponse) edu.ucsb.cs.rpc.soap.service.types.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
