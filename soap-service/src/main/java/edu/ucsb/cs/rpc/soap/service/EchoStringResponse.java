        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":echoStringResponse", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "echoStringResponse", xmlWriter);
            }
        }
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"echoStringResponse".equals(type)) {
                            ...
                            return (EchoStringResponse) edu.ucsb.cs.rpc.soap.service.types.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
